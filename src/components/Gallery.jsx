...
export default function Gallery({ Gallery}){
    return(
        <div className=" grid grid-rows-3 bg-[#e76da6] pt-20 ">
            <div className="pt-10 md:text-8xl text-6xl text-blue-800 md:ml-16  ml-10 fonthead">The Gallery
            <p className="text-2xl  text-white py-8 paratext">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, doloremque.deserunt.<br/> Sint id necessitatibus, blanditiis repellendus corporis.</p>
            </div>
