  ...
  return (
    <div className='lg:flex block justify-between'>
     ...
     <div className='bg-gray-100 lg:px-32 lg:py-20 lg:w-2/3 w-full py-10'>
      <h1 className='font-light  text-[#0404c2] fonthead lg:text-6xl text-3xl' >About Us</h1>
       
      <h3 className='mt-10 paratext' >We are team of passionate event organizers who strive to create unforgettable experiences for out attendeed</h3>
      <br />
