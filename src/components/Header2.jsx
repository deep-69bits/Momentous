...
function Header2() {
  ...
  return (
    <nav className="bg-yellow-500 sm:full m-auto paratext   mt-0  " >
    <div className=" mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between h-16">
        <div className="flex items-center w-full">
          <div className="hidden md:block w-full">
            <div className="ml-10 flex items-baseline justify-between space-x-4">
              ...
              <div>
                <a to="/" href='/'  className=" hover:bg-yellow-700 hover:text-white px-3 py-2 rounded-md  text-white font-semibold text-lg">Home</a>  
                <Link  className=" hover:bg-yellow-700 hover:text-white px-3 cursor-pointer py-2 rounded-md  text-white font-semibold text-lg" to="gallery" spy={true} smooth={true} offset={50} duration={500}>	Gallery </Link>
                <Link  className=" hover:bg-yellow-700 hover:text-white px-3 cursor-pointer py-2 rounded-md  text-white font-semibold text-lg" to="about" spy={true} smooth={true} offset={50} duration={500}>	About </Link>
                <a to="/invite" href='/invite'  className=" hover:bg-yellow-700 hover:text-white px-3 py-2 rounded-md  text-white font-semibold text-lg">Save The Date</a>  
                <a to="/photobooth" href='/photobooth'  className=" hover:bg-yellow-700 hover:text-white px-3 py-2 rounded-md  text-white font-semibold text-lg">Photo Booth</a>  
        ...
        <img className='h-40 w-60 translate-x-[-230px] ' src="https://ik.imagekit.io/cmef8hxb6/1_Transparent_Image_VWmbhlojN.png?updatedAt=1681756446542" alt="" />
          ...
          <button onClick={toggleMenu} className="inline-flex items-center justify-center p-2 rounded-md text-white font-semibold text-lg hover:text-white  " aria-expanded="false">
    ...
    <div className={`${menuOpen ? 'block' : 'hidden'} md:hidden`}>
      <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 grid grid-flow-row grid-cols-1">
