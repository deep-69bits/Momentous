...
const PricingCard = ({ title,desc,price,button,feaures }) => {
  return (
    <div className="shadow-lg rounded-lg py-4 px-4 pb-20">
      <h2 className="text-xl font-medium">{title}</h2>
       <h3 className="text-md py-2 text-yellow-700">{desc}</h3>
       <h2 className="py-4 text-5xl font-medium">
         ${price} <sup className="text-[12px] text-yellow-700 ">/Month</sup>
       </h2>

       <button className="w-full text-center text-yellow-700 py-2 border-yellow-700 border-[1px] my-5 mx-2">
       {button}
       </button>
...
const Pricing = () => {
  ...
  return (
    <>
    <hr  className="lg:w-[85%] translate-y-[-100px] w-full m-auto" />
